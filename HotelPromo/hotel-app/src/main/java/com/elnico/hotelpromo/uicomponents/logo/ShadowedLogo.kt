...
@Composable
internal fun ShadowedLogo(modifier: Modifier, text: String, fontSize: Int? = null) {
    ConstraintLayout(modifier) {
        ...
        Text(text = text, modifier = Modifier.constrainAs(lowerLabel) {
            ...
            fontSize = (fontSize ?: 70).sp, fontFamily = FontFamily(Font(R.font.greatvibes)), lineHeight = (fontSize ?: 75).sp)
